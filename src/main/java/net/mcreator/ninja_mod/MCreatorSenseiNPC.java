...
public class MCreatorSenseiNPC extends Elementsninja_mod.ModElement {
	public static final int ENTITYID = 1;
	public static final int ENTITYID_RANGED = 2;

	public MCreatorSenseiNPC(Elementsninja_mod instance) {
		super(instance, 9);
	}
	...
	public static class EntityCustom extends EntityCreature {
		public EntityCustom(World world) {
			...
			enablePersistence();
			this.tasks.addTask(1, new EntityAIWatchClosest(this, EntityPlayer.class, (float) 6));
			this.tasks.addTask(2, new EntityAIWatchClosest(this, EntityPlayerMP.class, (float) 6));
		...
		protected void applyEntityAttributes() {
			...
			if (this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(9999D);
